...
namespace ClusterSimulator
{
	...
	public:
		...
		Queue(ClusterSimulation& cluster);
		/// Creates a custom queue with custom priority and name.
		Queue(ClusterSimulation& cluster, int priority, std::string name = std::string());
		Queue(ClusterSimulation& cluster, const std::string& name);
		~Queue();
	...
	private:
		...
		// fields
		std::vector<ClusterSimulator::Job> jobs_;
		// TODO: maybe unnecessary
		std::vector<ClusterSimulator::Job> pending_jobs_;
		std::vector<ClusterSimulator::Job> running_jobs_;
		std::vector<ClusterSimulator::Job> suspended_jobs_;
